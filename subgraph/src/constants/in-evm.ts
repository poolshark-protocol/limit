...
export const STABLE_POOL_ADDRESS = '0xc3ee1e425bc2e3cd5088b9ddc6e27c293eb491db'
...
// chain WETH address
export let WETH_ADDRESS = '0x69011706b3f6c6eaed7d2bc13801558b4fd94cbf'

// tokens where USD value is safe to use for globals
export let WHITELISTED_TOKENS: string[] = [
  '0x69011706b3f6c6eaed7d2bc13801558b4fd94cbf', // WINJ
